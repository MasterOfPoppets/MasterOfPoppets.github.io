...
const content = () => (
	<article>
		...
		<p>
			In my contract for <Link to="/portfolio/the-performance-window-group/">PWG</Link> we ended up writing many endpoints to retrieve data
		...
		<p>
			...
			React (via Relay). I am hoping to create a simple <a href="http://netrunnerdb.com/">deckbuilder</a> application for the card game
			<a href="https://en.wikipedia.org/wiki/Android:_Netrunner">Android: Netrunner</a> using this little stack.
		</p>
		<p>
			Stay tuned for more!
		</p>
